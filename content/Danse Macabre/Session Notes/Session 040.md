...
Arythas and Dia come up as Inky is explaining that there are ghouls here, undeath. Inky says that there is a death god that is pulling the strings, and that the undead are a problem. [[Ilxavar]] explains that they have been trying to find research on a weapon that was made and used by a taskforce led by an elf. [[Soldos]] was the elf that led a taskforce that used a weapon. The weapon was used once, and never again because of here. The hobgoblins were trying to figure out why it was deployed here and not the capital — usage would destroy the entire capital, and cripple the empire’s everything in minutes, but it was never used there.
